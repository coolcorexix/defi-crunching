...
export interface CakeSyrupPoolInterface extends utils.Interface {
  functions: {
...
export type ZeroFreeIFOEvent = TypedEvent<
  [string, BigNumber],
  ZeroFreeIFOEventObject
>;

export type ZeroFreeIFOEventFilter = TypedEventFilter<ZeroFreeIFOEvent>;

export interface CakeSyrupPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CakeSyrupPoolInterface;
  ...
  filters: {
    ...
    "ZeroFreeIFO(address,uint256)"(
      sender?: string | null,
      currentBlock?: null
    ): ZeroFreeIFOEventFilter;
    ZeroFreeIFO(
      sender?: string | null,
      currentBlock?: null
    ): ZeroFreeIFOEventFilter;
