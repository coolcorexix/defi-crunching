...
export interface ManualCakeSyrupPoolInterface extends utils.Interface {
  functions: {
...
export interface ManualCakeSyrupPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ManualCakeSyrupPoolInterface;
